...
@section('title-block') Dashboard Page @stop

@section('content')
        <section class="banner_section">
            <div class="banner-main">
                <img src="icon/images/index bg.jpg" />
                <div class="container">
                    ...
                    <div class="text-bg relative">
                        ...
                        <a href="playlists.html" class="listen">Listen Now</a>
                    </div>
            ...
            <div class="container">
                <div class="row" align="center">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12" >
                        <div class="for-box">
                            <i><img src="icon/index-box.jpg" alt="icon"/></i>
                            <h3>Custom Player</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for-box">
                            <i><img src="icon/untitled (1).jpg" alt="icon"/></i>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for-box">
                            <i><img src="icon/index2.jpg" alt="icon"/></i>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 padding">
                    <div class="img-box">
                        <figure><img src="icon/images/music-wallpaper.jpg" alt="img" /></figure>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 padding">
                    <div class="text-box">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="news-box">
                            <figure><img src="icon/index-box.jpg" alt="img" /></figure>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="news-box">
                            <figure><img src="icon/untitled (1).jpg" alt="img" /></figure>
                            <h3>Best Music</h3>
                            <span> March 20</span><span>Comment</span>
                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, </p>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="news-box">
                            <figure><img src="icon/index2.jpg" alt="img" /></figure>
                            <h3>Live With Music</h3>
                            <span> March 20</span><span>Comment</span>
                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, </p>
                        </div>
